...
echo '<p style="text-align: justify;"><span style="color: #000000;">Da un&#8217;idea di Francesco Pellegrino di <a href="https://www.insecurenet.com/">InSecureNet</a> che, con la sua esperienza lavorativa ha identificato nella <em>disinformazione</em> la maggiore vulnerabilita\' informatica,  e anche grazie all&#8217;iniziativa del <a href="http://pingiovani.regione.puglia.it/">Progetto PIN</a> promosso dalla <a style="color: #000000;" href="https://www.regione.puglia.it/">Regione Puglia</a>, nasce <a href="https://www.firew4ll.com/">Firew4LL</a>, un appliance con a bordo un sistema operativo, derivante dal fork di <em>pfSense</em>, completamente tradotto in italiano correlato da relativa documentazione.</span></p>';
echo '<p> </p>';
echo '';
echo '';
echo '<p style="text-align: justify;"><span style="color:#000000" class="has-inline-color">La scelta nell&#8217;utilizzare la lingua italiana per dei prodotti tecnologici e informatici, visto lo spostamento totale del settore verso le lingue anglofone e nonostante possa sembrare in controtendenza, e&#8217; ricaduta per rendere piu&#8217; consapevoli gli utilizzatori del &#8220;Bel Paese&#8221; perche&#8217;</span>:<span style="color:#000000" class="has-inline-color"> &#8220;r<em>endersi consapevoli significa rafforzare la propria sicurezza ed essere meno esposti ad eventuali minacce</em>&#8220;.</span></p>';
echo '';
echo '';
echo '';
