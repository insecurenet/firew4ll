...
export FREEBSD_BRANCH=${FREEBSD_BRANCH:-"RELENG_0_1"}
...
export POUDRIERE_PORTS_GIT_BRANCH=${POUDRIERE_PORTS_GIT_BRANCH:-"${REPO_BRANCH_PREFIX}RELENG_0_1"}
...
if [ -n "${_IS_RELEASE}" -o -n "${_IS_RC}" ]; then
	...
	export PKG_REPO_BRANCH_RELEASE=${PKG_REPO_BRANCH_RELEASE:-"${REPO_BRANCH_PREFIX}v0_1"}
